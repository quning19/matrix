...
# -*- coding: utf-8 -*
import logging
from matrix.base.Singleton import Singleton
from matrix.utils.ColorizingStreamHandler import ColorizingStreamHandler
from matrix.utils.progress.bar import (
...
if __name__ == '__main__':
    ...
    test = range(0,68)
    print(bar)
    bar.debug("Test test %s test","sometest")
